...
$recipient = "parker.emailaddress@gmail.com,laura_bresko@yahoo.com, ";
...
$colleague = Trim(stripslashes($_POST['additional_email_2']));
...
if (!preg_match("^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$", $email)) $validationOK=false;
if (!$validationOK) {
	$validationOK=true;
	$errorTop = "Please review your data.";
...
$Body1 .= $email;
$Body1 .= "\n";
$Body1 .= "Additional Email: ";
$Body1 .= $principal;
$Body1 .= "\n";
$Body1 .= "Additional Email 2: ";
$Body1 .= $colleague;
$Body1 .= "\n";
$Body1 .= "\n";
$Body1 .= "Comments: ";
